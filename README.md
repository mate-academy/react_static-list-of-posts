...
- Replace `<your_account>` with your Github username in the
  [DEMO LINK](https://Anastasiia-Diachenko.github.io/react_static-list-of-posts/)
...
PostList (Post (title - body of the post - User (name, email, address) - CommentList (Comment (name, body, email))))