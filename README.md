...
## Task
- Implement an application with 5 components `PostList`, `Post`, `UserList`, `CommentList` and `Comment`
...
- Each post in `PostList` is represented by a `Post` component. It should show:
  ...
  - the `UserList` component showing the `name`, `email` and `address` of the author of the post
