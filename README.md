...
- Replace `OlgaOchichenko` with your Github username in the [DEMO LINK](https://OlgaOchichenko.github.io/react_static-list-of-posts/) and add it to the PR description.
