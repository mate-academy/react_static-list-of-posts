...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://maryna-mazur.github.io/react_static-list-of-posts/) and add it to the PR description.
